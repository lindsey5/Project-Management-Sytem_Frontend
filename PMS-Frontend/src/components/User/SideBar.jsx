...
const SideBar = () => {
    ...
    return <aside className="z-50 px-4 py-10 fixed top-0 left-0 bottom-0 bg-gray-100 flex flex-col gap-3 border-r-1 border-gray-200">
        {showSearch && <ProjectSearch close={() => setShowSearch(false)}/>}
            ...
            <Tooltip title="Projects" placement="left-end" arrow>
                <IconButton size="medium" sx={(showSearch || pathname.includes('/project')) && bg} onClick={() => setShowSearch(!showSearch)}>
